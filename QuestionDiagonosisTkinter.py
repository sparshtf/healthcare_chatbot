...
class MainForm(Frame):
    ...
    def __init__(self, master=None):
        ...
        self.createWidget()
    def createWidget(self):
        self.lblMsg=Label(self, text="Select Your Choice", bg="blue", width="300", height="3", font=("Times New Roman", 16))
        self.lblMsg.pack()
        self.btnLogin=Button(self, text="Login", height="4", width="35", command=self.lblLogin_Click)
        self.btnLogin.pack()
        self.btnRegister=Button(self, text="Register", height="4", width="35", command=self.btnRegister_Click)
...
class Login(Frame):
    ...
    def __init__(self, master=None):
        ...
        self.createWidget()
    def createWidget(self):
        self.lblMsg=Label(self, text="Please enter details below to login",bg="blue", width="300", height="3", font=("Times New Roman", 16))
        self.lblMsg.pack()
        self.username=Label(self, text="Username * ", width="300", height="3", font=("Times New Roman", 16))
        self.username.pack()
        self.username_verify = StringVar()
        self.username_login_entry = Entry(self, textvariable=self.username_verify)
        self.username_login_entry.pack()
        self.password=Label(self, text="Password * ", width="300", height="3", font=("Times New Roman", 16))
        self.password.pack()
...
class SignUp(Frame):
    ...
    def createWidget(self):
        ...
        self.btnRegister=Button(self, text="Register", width=10, height=3, bg="blue", command=self.register_user)
        self.btnRegister.pack()
