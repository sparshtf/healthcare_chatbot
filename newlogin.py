...
def main_account_screen(frmmain):
    ...
    Label(main_screen,text="Select Your Choice", bg="blue", width="300", height="3", font=("Times New Roman", 20)).pack()
    Label(main_screen,text="").pack()
    Button(main_screen,text="Login", height="4", width="35", command=login, font=("Times New Roman", 18)).pack()
    Label(main_screen,text="").pack()
    Button(main_screen,text="Register", height="4", width="35", command=register, font=("Times New Roman", 18)).pack()
